...
- [ ] Finalize product goal, scope, and non-goals
...
- [ ] Define credential model and security posture
- [ ] Define mobile UX priorities
- [x] Define approval workflow policy (both draft-for-review and direct publish must exist)

## Phase 2 — Architecture
- [ ] Choose stack for API, frontend, worker, queue
- [ ] Define repo structure
- [ ] Define provider adapter contract
- [ ] Define OAuth callback + token refresh architecture
...
- [ ] Implement mobile-responsive queue/calendar view
